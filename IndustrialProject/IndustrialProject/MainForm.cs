...
namespace IndustrialProject
{
    public partial class MainForm : Form
    {
        ...
        // Error highlighting, semi-hard coded for now but should be easy to scale from here.
        ...
        // Load devices via keyboard shortcuts
        ...
        // These load each device via the FILE menu
        ...
        // Needs to be a bool to avoid the program crashing if user decides to cancel opening a file
